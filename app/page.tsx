			...
			<div className="relative overflow-hidden">
				<div className="h-dvh w-full overflow-auto">
					...
					<div className="bg-(--background-color) h-dvh overflow-auto">
						<main className="relative flex flex-col p-10 sm:p-16 gap-10">
							...
							<div className="px-10 text-lg space-y-4">
								...
								<p>
									Hi, I&apos;m Gehér Marcell and I build full-stack web
									applications using <b>Next.js</b>.
								</p>
								<p>
									I develop modern, responsive, and user-friendly web
									applications that solve real problems. I&apos;m also keen on
									creating desktop applications using <b>C#</b> (.NET and
									Unity), and I have experience in <b>PHP</b> and <b>Java</b>{" "}
									development.
								</p>
								<p>
									I&apos;m currently a fifth-year computer science student at
									the Jedlik Ányos high school in Győr, Hungary. I&apos;m
